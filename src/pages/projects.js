...
export default function projects({ hero, featured, proj, blog, contact }) {
  return (
    <div>
      ...
      <div>
        {hero
          .filter((element) => element.fields.kicker === "our specialty")
          .map((heroItem) => (
      ...
      <div className=" grid grid-cols-12 gap-4 ">
        <div className="my-24 col-start-2 col-span-10">
          {featured
            .filter(
              (featuredElements) =>
                featuredElements.fields.kicker === "our expertise"
            )
